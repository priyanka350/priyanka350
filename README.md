...
<img width="1266" height="315" alt="Picture3g" src="https://github.com/user-attachments/assets/7ba2b304-4f84-49fb-9d30-fb29c249e607" />
...
| **DropSense AI**    | A complete **machine learning** development pipeline for DropSense AI, covering dataset exploration, feature engineering, model evaluation, **SHAP** explainability, and deployment preparation. 🧠🧑‍🎓                           | [GitHub Link](https://github.com/priyanka350/DropSense-AI) |
| **Netflix Clone**            | Developed a responsive web interface resembling Netflix using **HTML** and **CSS** 📺✨                                   | [Github Link](https://github.com/priyanka350/NetflixClone) |
